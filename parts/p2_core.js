...
var state = {
  ...
  data: { settings:null, clients:[], reqs:[], workers:[], shifts:[], notes:[], incidents:[], reminders:[], flags:[], avail:[], clocks:[], invoices:[], enums:{}, nearMisses:[], overnightLogs:[] }
};
...
function loadAll(){
  ...
  return Promise.all([
    ...
    D.nearMisses = r[13] || []; D.overnightLogs = r[14] || [];
    D.enums = {};
