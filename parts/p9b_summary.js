...
function sumFindings(ds){
  ...
  out.push(s.falls + ' fall' + (s.falls === 1 ? '' : 's') + ' and ' + s.nearMisses + ' near miss' + (s.nearMisses === 1 ? '' : 'es') + ' were recorded' + (s.events ? '; ' + s.transferRelated + ' of ' + s.events + ' at a recorded transfer location; ' + s.secondPerson + ' fall' + (s.secondPerson === 1 ? '' : 's') + ' where a second person was needed to get up; ' + s.emergencyCalls + ' emergency call' + (s.emergencyCalls === 1 ? '' : 's') : '') + '.');
